            ...
            <form className='md:p-8 w-full max-w-md rounded-lg md:border border-gray-200 mx-4'>
                ...
                <div className='mb-2'>
                    <div className='border bg-white p-2 rounded-lg flex items-center  focus-within:ring-1'>
                        <span className='pr-2 text-2xl text-gray-500'><CiUser/></span>
                        <input
                            type="text"
                            name='name'
                            required
                    ...
                    {
                        errors.name?._errors && <p className='text-xs m-0 text-red-500'>{errors.name?._errors}</p>
                    }
                </div>
                <div className=' mb-2'>
                    <div className='border bg-white p-2 rounded-lg flex items-center focus-within:ring-1'>
                ...
                <div className='mb-2'>
                    <div className='border p-2 bg-white rounded-lg flex items-center focus-within:ring-1'>
                        <span className='pr-2 text-2xl text-gray-500'><MdOutlinePermPhoneMsg /></span>
                        <input
                            type="number"
                            name='contact'
                            value={input.contact}
                    ...
                    {
                        errors.contact?._errors && <p className='text-xs m-0 text-red-500'>{errors.contact?._errors}</p>
                    }
                </div>
                ...
                <div className='flex flex-col-reverse items-center mt-8 p-4  border-t-2 border-t-slate-300'>
                    <p className='font-semibold'>Already have an Account ? <Link to={"/login"} className='text-blue-400'>Login</Link></p>
                </div>
            </form>
        </div>
    )
