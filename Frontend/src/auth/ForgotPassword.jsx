    ...
    <div className='flex items-center justify-center min-h-screen w-full'>
          <form className='flex flex-col gap-5 p-4 md:p-8 w-full max-w-md rounded-lg'>
              <div className='text-center'>
                ...
                <p className='textt-sm text-gray-600'> Enter your email address to reset your Password</p>
              </div>
              <div className=' mb-1'>
              ...
              <div className='flex flex-col justify-center gap-2'>
                  <button  className='w-full text-white bg-orange-400 cursor-pointer border p-2 rounded-lg '>Send Reset Link</button>
